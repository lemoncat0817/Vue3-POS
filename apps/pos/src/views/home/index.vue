...
class="bg-red-300 text-blue-800 md:text-[10px] text-[8px] font-bold border-solid border-2 border-black rounded-lg mr-2 px-1 select-none active:bg-yellow-300 2xl:text-base xl:text-sm lg:text-xs"
        ...
        <div class="w-full h-[90%]">
          <el-table
:data="drinkStore.drinkNotPay" border height="100%" style="width: 100%"
            empty-text="目前無待付款的飲品" @selection-change="handleSelectionChange">
...
v-for="item in slicePercentDiscount" :key="item.id" class="h-16 mb-1 flex justify-center items-center cursor-pointer bg-red-400 rounded-xl"
                ...
                <div class="w-[468px] h-10 bg-gray-400 shadow-xl rounded-lg flex justify-around items-center">
                  ...
                  <div class="h-full flex items-center">
                    <el-pagination
v-model:current-page="percentDiscountCurrentPage" small background
...
const handleSelectionChange = (drinkSelect: CartLineItem[]) => {
