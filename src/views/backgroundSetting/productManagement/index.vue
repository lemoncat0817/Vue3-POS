    ...
    <div class="flex justify-between mt-2">
      ...
      <div class="flex mr-2">
        ...
        <button @click="deleteDrinkType"
          ...
          class="lg:px-2 px-0.5 border-2 border-solid border-black rounded-lg mx-1 lg:text-md md:text-sm text-xs text-blue-800 font-bold bg-red-500 select-none active:bg-yellow-300">刪除</button>
        <!-- 編輯功能 -->
        <button @click="openEditTypeDialog"
          :class="{ 'opacity-50': loginStore.userInfo.canSetDrinkType === 'X', 'pointer-events-none': loginStore.userInfo.canSetDrinkType === 'X' }"
          class="lg:px-2 px-0.5 border-2 border-solid border-black rounded-lg mx-1 lg:text-md md:text-sm text-xs text-blue-800 font-bold bg-red-500 select-none active:bg-yellow-300">編輯</button>
        <!-- 編輯飲品類型 -->
    ...
    <div class="flex justify-between mt-2">
      ...
      <div class="flex mr-2">
        ...
        <button @click="openAddDrinkDialog"
          ...
          class="lg:px-2 px-0.5 border-2 border-solid border-black rounded-lg mx-1 lg:text-md md:text-sm text-xs text-blue-800 font-bold bg-red-500 select-none active:bg-yellow-300">新增</button>
        <!-- 新增飲品類型 -->
