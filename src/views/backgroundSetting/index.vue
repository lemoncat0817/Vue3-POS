<template>
  <div class="w-full flex items-center flex-col overflow-y-auto ">
    ...
    <div class="w-4/5 h-[600px] mt-6 border-2 border-solid border-black rounded-lg flex ">
      <!-- 飲品類型 -->
      <div class="flex-[1]">
      ...
      <div class="flex-[1] border-x-2 border-solid border-black rounded-lg">
        ...
        <div>
          ...
          <div class="w-full h-10 bg-gray-400 shadow-xl rounded-lg flex justify-around items-center mt-10">
            <p v-if="currentType.drinkList" class="text-blue-800">{{ `共 ${currentType.drinkList.length} 樣` }}
            </p>
            <p v-else class="text-blue-800">共 0 樣</p>
            <div class="h-full flex items-center">
